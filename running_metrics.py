...
PACE_ZONES = [
    ('Zone 1 (easy)',      7.0, 99.0),
    ('Zone 2 (aerobic)',   5.5,  7.0),
    ('Zone 3 (tempo)',     4.5,  5.5),
    ('Zone 4 (threshold)', 3.8,  4.5),
    ('Zone 5 (race)',      0.0,  3.8),
]
...
def compute_cadence(df, sample_rate=100):
    peaks, _ = find_peaks(df['az'].values, height=0.3, distance=sample_rate * 0.25)
